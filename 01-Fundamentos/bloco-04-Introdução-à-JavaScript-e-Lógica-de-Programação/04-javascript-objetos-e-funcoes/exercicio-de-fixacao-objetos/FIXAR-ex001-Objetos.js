...
console.log(`\nExecircio 2: Consultando informção do objeto.`)
...
console.log(`\nExecircio 3: Adicionando valores ao objeto.`)
...
console.log(`\nExecircio 4: Consultando elementos do objeto adicionado.`)
...
console.log(`\nExecircio 5: Consultando elementos do objeto adicionado.`)
