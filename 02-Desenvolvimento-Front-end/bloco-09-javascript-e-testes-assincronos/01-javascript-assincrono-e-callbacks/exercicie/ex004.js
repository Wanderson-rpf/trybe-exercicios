...
// para que termine o envio. Crie a função sendMarsTemperature de forma que:
//    A função sendMarsTemperature imprima no console o seguinte 
//      texto: "A temperatura de Marte é: temperaturaAtual graus celsius" onde, temperaturaAtual é o valor recebido 
//      da função getMarsTemperature; e
...
const sendMarsTemperature = (currentTemperature) => {
